...
class FhirUtils {
  ...
  /**
   * Location of published FHIR specification
   * This is generated by running publish tool from FHIR source or downloading the whole
   * spec package.
   */
  private final static File publishDir
